...
package com.android.image.sample;
...
import com.android.image.sample.activity.R;
...
public class GPUImageFilterTools {  
    ...
    private static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_action_search));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
