...
public class record extends Activity implements OnClickListener, SurfaceHolder.Callback{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mGPUImage.setGLSurfaceView((GLSurfaceView) cameraView);
	...
	private void initRecorder() {// this takes care of all the mediarecorder settings
	    ...
	    String video= "/DCIM/100ANDRO/Video";
...
//	     recorder.setProfile(cpHigh);        
	    ...
	    recorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);// generally used also includes h264 and best for flash
	    recorder.setVideoEncoder(MediaRecorder.VideoEncoder.DEFAULT); //well known video codec used by many including for flash
